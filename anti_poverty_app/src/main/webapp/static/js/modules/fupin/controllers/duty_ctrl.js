...
function renderCheckAreaLevel1(id) {
  ajax({
    url:ctx+'/data/duty/child_districts_list/' + id + '.json',
    dataType:'json',
...
function renderBangFuDetail(id) {
  ajax({
    url:ctx+'/data/duty/duty_intro/' + id + '.json',
    dataType:'json',
    error:function(a,b){console.log(a,b)},
    success:function(data){
      var code = data.code,
...
function renderBangFuOrganization(id) {
  ajax({
    url:ctx+'/data/duty/duty_organization_list/' + id + '.json',
    dataType:'json',
    error:function(a,b){console.log(a,b)},
    success:function(data){
      var code = data.code,
...
function renderBangFuPeople(id){
  ajax({
    url:ctx+'/data/duty/duty_responsible_people_list/' + id + '.json',
    dataType:'json',
    error:function(a,b){console.log(a,b)},
    success:function(data){
      var code = data.code,
...
function renderBangFuCountry(id){
  ajax({
    url:ctx+'/data/duty/duty_organization_country_list/' + id + '.json',
    dataType:'json',
    error:function(a,b){console.log(a,b)},
    success:function(data){
      var code = data.code,
