...
/**
 * SqFilterInfoTemp entity. 
 * @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "SQ_FILTER_INFO_TEMP")
public class SqFilterInfoTemp implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -437351327202759393L;
	// Fields
	...
	/** default constructor */
	public SqFilterInfoTemp() {
	}

	/** minimal constructor */
	public SqFilterInfoTemp(String id, String relationId, String relation, 
			String mpTableId,String sqTable,String mpColumnId, String sqColumn, String formulaId,
	...
	/** full constructor */
	public SqFilterInfoTemp(String id, String filterType, String relationId,
