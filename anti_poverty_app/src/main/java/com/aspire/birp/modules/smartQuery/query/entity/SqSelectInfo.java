 ...
 */
@Entity
@Table(name = "SQ_SELECT_INFO")
public class SqSelectInfo implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7215448219325256896L;
	private String id;
	...
	/** minimal constructor */
	public SqSelectInfo(String id, String mpTableId,String sqTable, String mpColumnId, String sqColumn,
	...
	/** full constructor */
	public SqSelectInfo(String id, String mpTableId, String sqTable,
