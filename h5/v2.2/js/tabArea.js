...
function tabAreaCommon(){
	$(".nav-country").addClass('hide');
	$(".countryHide").removeClass('hide');
...
function tabProvince(areaName){
	...
	renderTabCommon(LEVELS.PROVINCE, areaName, 'zhipinyuanyin');
	AREA_LEVEL="province";
 	AREA_NOW=areaName;
}
...
function tabCity(areaName){
	...
	renderTabCommon(LEVELS.CITY, areaName, 'zhipinyuanyin');
	AREA_LEVEL="city";
 	AREA_NOW=areaName;
}
...
function tabCounty(areaName){
	...
	renderTabCommon(LEVELS.COUNTY, areaName, 'zhipinyuanyin');
	AREA_LEVEL="county";
 	AREA_NOW=areaName;
}
...
function tabTown(areaName){
	...
	renderTabCommon(LEVELS.TOWN, areaName, 'zhipinyuanyin');
	AREA_LEVEL="town";
 	AREA_NOW=areaName;
}
...
function tabCountry(areaName){
	...
	$(".countryHide").addClass('hide');
	$(".nav-country").removeClass('hide');
	$("#rightInner .selector-title").text("致贫原因");
	renderLocation(LEVELS.COUNTRY, areaName);
	renderTabCommon(LEVELS.COUNTRY, areaName, 'zhipinyuanyin');
	AREA_LEVEL="country";
 	AREA_NOW=areaName;
