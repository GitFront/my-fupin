	...
	<script type="text/html" id="tplAlarm">
		<table>
			<tr>
				...
				<td >
					<p>建档立卡数据</p>
					<p><b <#=# records_count != 0 ? 'data-target="alarmed_records"' : ''#>><#=records#></b>项异常</p>
				</td>
			</tr>
			<tr>
				<td >
					<p>帮扶资金&lt;30万的</p>
					<p><b <#=# country_poor != 0 ? 'data-target="alarmed_country"' : ''#>><#=country#></b>个相对贫困村</p>
				</td>
				<td >
					<p>一年内未被走访的</p>
					<p><b <#=# visit_poor_fam != 0 ? 'data-target="alarmed_family_not_visited"' : ''#>><#=family_not_visited#></b>户贫困户</p>
				</td>
			</tr>
		</table>
	</script>
...
<%-- 	<script src="${ctxStatic}/js/modules/fupin/controllers/poor_country_detail_ctrl.min.js"></script>
	...
	<script type="text/javascript" src="${ctxStatic}/js/modules/fupin_strategy/data.min.js"></script>
