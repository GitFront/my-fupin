			...
			<!--公共地图部分-->
				...
				<div class="block no-border block-bottom" id="blockBottom">
					<div class="blue-select">
						<div id="btnMapIndex" class="btn btn-area"><strong>自然村达标村数</strong><i class="icon icon-arrow"></i></div>
						<ul class="select-list" id="scopeList">
							<li data-index="1">相对贫困村数</li>
							<li data-index="2">示范村达标村数</li>
							<li data-index="3">示范村达标比例</li>
							<li data-index="4">完成提升创建村数</li>
							<li data-index="5">完成提升创建村比例</li>
							<li data-index="6">20户以上自然村数</li>
							<li class="active" data-index="7">自然村达标村数</li>
							<li data-index="8">自然村达标村比例</li>
							<li data-index="9">完成提升创建自然村数</li>
							<li data-index="10">完成提升创建自然村比例</li>
						</ul>
					</div>
...
<%-- 	<script type="text/javascript" src="${ctxStatic}/js/modules/script/data3.min.js"></script> --%>
    ...
    <script type="text/javascript" src="${ctxStatic}/js/modules/script/echarts-all-3.min.js"></script>
</body>
</html>
