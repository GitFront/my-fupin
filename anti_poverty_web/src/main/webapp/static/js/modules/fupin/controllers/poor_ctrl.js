...
$(function(){
renderLocation(LEVELS.PROVINCE, DEFAULT_AREA);
renderTabCommon(LEVELS.PROVINCE, DEFAULT_AREA, TAB_NAMES.ZHIPINYUANYIN);
...
/*指标下拉selector*/
	...
	$("#mainRightShrink .arrow-right").click(function(event) {
		if(!$(this).hasClass('arrow-left')){
			...
			$("#rightInner").animate({width:"345px",opacity:"1"},function(){
