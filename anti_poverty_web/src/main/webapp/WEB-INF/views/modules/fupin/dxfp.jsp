		...
		<div class="block no-border block-top" id="blockTop">
			<ul>
				<li class="data1">
					...
					<div class="bar-wrap">
						<div class="bar-bg"><div class="bar" style="width:<#=top.rate_peer_county#>%"></div></div>
						<div class="rate"><#=top.rate_peer_county#>%</div>
					</div>
				</li>
				<li class="data1">
					...
					<div class="bar-wrap">
						<div class="bar-bg"><div class="bar" style="width:<#=top.rate_poor_people#>%"></div></div>
						<div class="rate"><#=top.rate_poor_people#>%</div>
					</div>
				</li>
			</ul>
		</div>
