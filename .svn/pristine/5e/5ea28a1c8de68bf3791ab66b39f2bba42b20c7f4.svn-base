...
/**
 * SqTableInfoTemp entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "SQ_TABLE_INFO_TEMP")
public class SqTableInfoTemp implements java.io.Serializable {

	// Fields

	private static final long serialVersionUID = -7298426623264811159L;
	private String id;
	...
	/** default constructor */
	public SqTableInfoTemp() {
	}

	/** minimal constructor */
	public SqTableInfoTemp(String id, String sqId, String creator,
	...
	/** full constructor */
	public SqTableInfoTemp(String id, String mpTableId, String sqTable,
	...
	@Column(name = "MP_TABLE_ID", length = 50)
	...
	@Column(name = "SQ_TABLE", length = 50)
