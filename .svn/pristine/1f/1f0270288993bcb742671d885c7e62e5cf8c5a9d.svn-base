(function(){
    ...
    var GZData = [
        [{name:'广州市'},{name:'梅州市',value:35}],
        [{name:'广州市'},{name:'清远市',value:34}],
        [{name:'广州市'},{name:'广州市',value:2}],
    ];
    var DGData=[
        [{name:'东莞市'},{name:'韶关市',value:25}],
        [{name:'东莞市'},{name:'揭阳市',value:30}],
        [{name:'东莞市'},{name:'东莞市',value:2}],
    ]

    var SZData=[
        [{name:'深圳市'},{name:'河源市',value:28}],
        [{name:'深圳市'},{name:'汕尾市',value:21}],
        [{name:'深圳市'},{name:'深圳市',value:2}]
    ]
    var ZHData=[
        [{name:'珠海市'},{name:'阳江市',value:28}],
        [{name:'珠海市'},{name:'茂名市',value:40}],
        [{name:'珠海市'},{name:'珠海市',value:2}],
    ]
    var FSData=[
        [{name:'佛山市'},{name:'湛江市',value:45}],
        [{name:'佛山市'},{name:'云浮市',value:31}],
