(function(win){
	var commonEchartConfig = {};
	//仪表图
	commonEchartConfig.genGuaranteeConfig = function(config){
		var guarantee_config= {
	        gauge_center:[["50%", "55%"]] ,
	        gauge_title_color:'#96b5ff',
	        gauge_item_color:'#6cc3ff',
	        gauge_split_width:1,
	        radius: "105%",
	        gauge_axis_show:false,
	        gauge_line_color: [
	           [[0.93, "#6cc3ff"], [1, "#f0e126"]]
	        ]
		};
		return Echart.utils.getOption(config,guarantee_config,"Gauge");
	};
	//饼图-块状
	commonEchartConfig.genPoorAnalysisConfig = function(config){
		var poor_analysis_config= {
	        valueName:'占比',//数据名称
	        radius:'70%',
	        isVisualMap:true,
	        pie_roseType :"radius",
	        pie_item_color:"#50ddf9",
	        pie_label_color:"#96b5ff",
	        pie_line_color:"#96b5ff",
	        visualMap_max: config.count
	    };
		return Echart.utils.getOption(config.listData,poor_analysis_config,"Pie");
	};
	//饼图
	commonEchartConfig.genChartPieConfig = function(config){
		var chartPie_config = {
	        valueName:'占比',//数据名称
	        radius:'70%',
	        pie_label_color:"#a0c0ff",
	        pie_line_color:"#a0c0ff"
	    };
		return Echart.utils.getOption(config,chartPie_config,"Pie");
	};
	//饼图-环形
	commonEchartConfig.genChartAnnularPieConfig = function(config){
		var chartAnnularPie_config = {
	        valueName:'占比',//数据名称
	        radius:['30%','70%'],
	        pie_label_color:"#a0c0ff",
	        pie_line_color:"#a0c0ff"
	    };
		return Echart.utils.getOption(config,chartAnnularPie_config,"Pie");
	};
	
	//饼图-环形1
	commonEchartConfig.genChartRoundPieConfig = function(config){
		var chartRoundPie_config = {
	        valueName:'占比',//数据名称
	        radius:['30%','70%'],
	        pie_label_color:"#a0c0ff",
	        pie_line_color:"#a0c0ff",
	        pie_label_show:false,/*是否显示标签*/
            pie_label_show2:false
	        
	    };
		return Echart.utils.getOption(config,chartRoundPie_config,"Pie");
	};
	
	//项目资金监控-气泡图
	commonEchartConfig.genChartBubbleConfig = function(config){
		var chartBubble_config = {
			grid_bottom:"20%",
			schema:["项目数","完成率","资金投入"],
	        xAxisName:"",
	        yAxisName:"",
	        yAxis_sline_color:"#404068",
	        yAxis_line_color:"#a0c0ff",
	        yAxis_label_color:"#96b5ff",
	        yAxis_text_color:"#96b5ff",
	        xAxis_text_color:"#96b5ff",
	        xAxis_sline_color:"#404068",
	        xAxis_line_color:"#a0c0ff",
	        xAxis_label_color:"#96b5ff",
	        visualMap_max: config.count
	    };
		
		return Echart.utils.getOption(config.listData,chartBubble_config,"Statter");
	};
	
	//柱状图带图例
	commonEchartConfig.genChartLegendBarsConfig = function(config){
		var chartBars_config = {
			grid_top:"10%",
			grid_bottom:"12%",
			yAxis_sline_color:"#404068",
	        yAxis_line_color:"#96b5ff",
	        yAxis_label_color:"#96b5ff",
	        color:["#96b5ff","#ed7d31","#fff478","#7fda7b"],
	        barCategoryGap:"70%",
//	        legendY:'160px',
		...
		return Echart.utils.getOption(config,chartBars_config,"Bars");
	};
	
	//柱状图带层级带图例
	commonEchartConfig.genChartLevelLegendBarsConfig = function(config){
		var chartBars_config = {
			grid_top:"10%",
			grid_bottom:"12%",
			yAxis_sline_color:"#404068",
...
//	        color:["#96b5ff","#ed7d31","#fff478","#7fda7b"],
	...
	//柱状图
	commonEchartConfig.genChartBarsConfig = function(config){
		var chartBars_config = {
			grid_top:"10%",
			grid_bottom:"12%",
			yAxis_sline_color:"#404068",
	...
	//折线柱状图
	commonEchartConfig.genChartLineBarsConfig = function(config){
		var chartLineBars_config = {
			grid_top:"10%",
			grid_bottom:"10%",
			yAxis_sline_color:"#404068",
			yAxis_line_color:"#96b5ff",
			...
			bar_label_show:false,
			line_percent:false,
			yAxis_sline_show:false,
			Axis_sline_show:false,
			legendItemWidth:20,
	        legendItemHeight:10,
	        isLegend:true
		};

		return Echart.utils.getOption(config,chartLineBars_config,"Bars");
	};
	
	win.commonEchartConfig = commonEchartConfig;
})(window);(function(win){
	var commonEchartConfig = {};
	//仪表图
	commonEchartConfig.genGuaranteeConfig = function(config){
	...
	commonEchartConfig.genChartRoundPieConfig = function(config){
		var chartRoundPie_config = {
	        ...
	        radius:['47%','77%'],
	        pie_label_show:false,/*是否显示标签*/
            pie_label_show2:false/*是否显示标签*/
	    };
		return Echart.utils.getOption(config,chartRoundPie_config,"RPie");
	};
...
//	        color:["#96b5ff","#ed7d31","#fff478","#7fda7b"],
	...
	//滚动时间轴
	commonEchartConfig.genVillageColumnGs = function (config){
		var cur = config[12].cur;
//已完成数据
        ...
        xAxis: [
            {
                ...
                'data':[
                    '编制整治规划','三清三拆三整治','村道巷道硬化','垃圾处理','污水处理',
                    '集中供水','住房建设','公共服务设施','成立村民理事会','自然村达标数'
...
return  option;
	...
	commonEchartConfig.genVillageColumnBfbR =function (config){
		var cur = config[12].cur;
		//已完成数据
