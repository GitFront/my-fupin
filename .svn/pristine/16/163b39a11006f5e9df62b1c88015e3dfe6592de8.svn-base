...
public class DataService {
	...
	public String getDataStaticData(Integer scope,String id,String level) {
		...
		try{
			...
			alarm.put("records_count", hpcount.get("S_BUILD_CARD_MONITOR")); //建档立卡总数
			alarm.put("country_poor", hpcount.get("S_FURTER_POOR_COUNTRY_CNT")); //相对贫困村数
			alarm.put("visit_poor_fam", hpcount.get("S_POOR_FAMILY_AMOUNT")); //贫困走访，累计贫户户数
