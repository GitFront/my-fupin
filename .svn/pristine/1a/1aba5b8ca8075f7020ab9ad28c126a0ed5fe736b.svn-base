(function(){
    var datas=[
        ...
        {for:{name:"江门市",coords:[113.0881407161,22.5845372113]},
            to:[{name:"崇左市",coords:[107.3715526830,22.3847952221],value:[21]}
        ...
        {for:{name:"茂名市",coords:[110.9317970381,21.6689767355]},
            to:[{name:"南宁市",coords:[108.3733749001,22.8229869980],value:[18.7]},
                {name:"来宾市",coords:[109.2288470198,23.7581976063],value:[7.6]}
		...
		{for:{name:"湛江市",coords:[110.3654848654,21.2772605433]},
            to:[{name:"柳州市",coords:[109.4219523872,24.3316585834],value:[22.0]}
            ]
        },
        ...
        {for:{name:"肇庆市",coords:[112.4717803427,23.0529978779]},
            to:[{name:"桂林市",coords:[110.2964461438,25.2798404899],value:[4.3]},
                {name:"贺州市",coords:[111.5730875639,24.4093844516],value:[9.1]}
