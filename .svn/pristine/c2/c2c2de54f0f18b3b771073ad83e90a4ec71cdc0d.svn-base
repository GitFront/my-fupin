...
public class MainController  {
	...
	@RequestMapping("/a")
	@ControllerLog(ActionName="登录",ModelName="用户登录")
	...
	*/
	...
	@ControllerLog(ActionName="数据监控菜单",ModelName="数据监控")
	...
	@ControllerLog(ActionName="责任监控菜单",ModelName="责任监控")
	...
	@ControllerLog(ActionName="项目监控菜单",ModelName="项目监控")
	...
	@ControllerLog(ActionName="资金监控菜单",ModelName="资金监控")
	...
	@ControllerLog(ActionName="示范村菜单",ModelName="示范村")
	...
	@ControllerLog(ActionName="责任监控菜单",ModelName="东西部扶贫")
	...
	@ControllerLog(ActionName="扶贫服务菜单",ModelName="扶贫服务")
	...
	@ControllerLog(ActionName="搜索模块",ModelName="搜索服务")
