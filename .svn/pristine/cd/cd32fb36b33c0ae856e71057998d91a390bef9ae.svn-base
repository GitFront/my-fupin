 ...
 */
@Entity
@Table(name = "SQ_SORT_INFO")
public class SqSortInfo implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -994764620796593967L;
	// Fields
	...
	/** minimal constructor */
	public SqSortInfo(String id,String mpTableId, String sqTable, String mpColumnId, String sqColumn,
	...
	/** full constructor */
	public SqSortInfo(String id, String mpTableId, String sqTable,
