 ...
 */
@Entity
@Table(name = "SQ_QUERY_INFO")
public class SqQueryInfo implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3927745740850205150L;
	// Fields
	...
	/** minimal constructor */
	public SqQueryInfo(String id, String name, String configType,
			String sqTable,String creatorId, String creator,String creatorAcc, Timestamp createTime) {
		this.id = id;
		this.name = name;
	...
	public SqQueryInfo(String id, String name, String configType,
			...
			String creatorAcc, Timestamp createTime, String sqSelectSql,
			String sqFromSql, String sqFilterSql, String sqSortSql,
			String sqColumns, Long sort) {
		super();
		this.id = id;
		this.name = name;
		this.configType = configType;
	...
	@Column(name = "SQ_COLUMNS", nullable = true, length = 4000)
	...
	@Column(name = "SQ_FILTER_SQL", nullable = true, length = 4000)
	...
	@Column(name = "SQ_SORT_SQL", nullable = true, length = 4000)
