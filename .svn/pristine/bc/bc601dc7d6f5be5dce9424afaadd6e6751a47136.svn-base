   ...
   var queryName="com.aspire.birp.modules.antiPoverty.dao.DataMonDao.queryMapCun";
    $(function(){
    	...
    	if(ret){ret.then(function(res){
    		  ...
    		  chartid = Highmap.mybatis.Map("map",queryName,{"type":type,"scope":scope,"newDate":statTime},
    		  	{key:'PAC',value:'POOR_POP',value2:'AID_POOR_POP',value3:'AID_POOR_POP_R'},"countries/cn/custom/cn-gongdong","PAC",option_);
    ...
    function loadMap(type,scope){
		...
		Highmap.mybatis.reloadData(chartid,queryName,{"type":type,"scope":scope,"newDate":statTime},mapper,valueMapper,colorStops);
